    ...
    <div class="my-circle">
         <div class="circle-header">
            ...
            <div class="circle-send" >
                <span class="circle-text">所有圈子</span>
            </div>
        </div>
...
export default {
    ...
    computed: {
        ...mapGetters({
			circle_list: 'all_circle',
            option: 'all_circle_option'
        })
    },
    watch: {
        option: {
		...
		circle_list: function (val, oldVal) {
            if (val) {
